...
1. clone the project `git clone git@github.com:spinner5/flashcards.git`
2. open terminal and locate the downloaded folder
3. change directory to that folder `cd flashcards`
